...
public class AcceuilFrontEndController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            File file=new File("C:\\wamp\\www\\PI4\\PI4\\web\\images\\"+CurrentUser.getNom_image());
    ...
    @FXML
    private void ProfileEdit(MouseEvent event) throws IOException {
        GestionUser = FXMLLoader.load(getClass().getResource("ProfileBaby.fxml"));
        setNode(GestionUser);
    }
    ...
    @FXML
    private void GetBabySitter(ActionEvent event) throws IOException {
        GestionBabySitter = FXMLLoader.load(getClass().getResource("BabysitterListe.fxml"));
