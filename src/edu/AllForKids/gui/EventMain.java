...
public class EventMain extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
           ...
           //root = FXMLLoader.load(getClass().getResource("AddOffre.fxml"));
           ...
           //root = FXMLLoader.load(getClass().getResource("BabysitterListe.fxml"));
           //root = FXMLLoader.load(getClass().getResource("ProfileBaby.fxml"));
