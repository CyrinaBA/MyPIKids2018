...
public class User {
    ...
    public User(int id, String username, String email, String password, String roles, String nom_image, String Sexe, String adresse, int enabled) {
     ...
     public User(int id, String username, String email, int Age, String Sexe, String adresse, String nom_image, String Ville, int nbrAnneeExp, String Etat, int numTel) {
         this.id=id;
         this.username=username;
         this.email=email;
         this.Age=Age;
