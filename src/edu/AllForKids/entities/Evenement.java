...
public class Evenement {
    ...
    public Evenement( String titre, Categorie Categorie, String nom_image, Date date_debut, Date date_fin, String lieu, String description, int ticket_disponible, int Tarif) {
     ...
     public Evenement( String titre, String nomcateg, String nom_image, Date date_debut, Date date_fin, String lieu, String description, int ticket_disponible, int Tarif) {
        this.titre = titre;
